...
export function Navbar () {
    ...
    return (
        <nav className="w-full flex py-6 justify-between items-center navbar">
            <img src={logo} alt="hoobnak" className="w-{124px} h-{32px}"/>
            ...
            <div className="sm:hidden flex flex-1 justify-end items-center">
                <img src={toggle ? close : menu} alt="menu" className="w-[24px] h-[24px] cursor-pointer" onClick={() => setToggle((prev) => !prev)}/>
                <div
